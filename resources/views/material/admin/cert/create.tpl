...
{include file='admin/main.tpl'}
	...
	<main class="content">
		<div class="content-header ui-content-header">
			<div class="container">
				<h1 class="content-heading">添加证书</h1>
			</div>
		</div>
		<div class="container">
							...
							<div class="card-main">
								<div class="card-inner">
									...
									<div class="form-group form-group-label">
										...
										<textarea class="form-control" id="cert" name="cert" rows="15"></textarea>
									</div>

									<div class="form-group form-group-label">
										<label class="floating-label" for="key">私钥，如果填地址/路径将会从地址/路径获取</label>
										<textarea class="form-control" id="key" name="key" rows="15"></textarea>
									</div>
