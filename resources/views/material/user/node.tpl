																...
																{foreach $nodes as $node}
																	...
																	<div class="card">
																		<div class="card-main">
																			...
																			{if $node->sort > 2 && $node->sort != 5 && $node->sort != 10 && $node->sort != 11 && $node->sort != 12 && $node->sort != 14}
																			...
																			{if $node->sort == 0||$node->sort==7||$node->sort==8||$node->sort==10||$node->sort==11||$node->sort==12||$node->sort==14}
																				...
																				{if ($node->sort==0||$node->sort==7||$node->sort==8||$node->sort==10||$node->sort==11||$node->sort==12||$node->sort==14)&&($node->node_speedlimit!=0||$user->node_speedlimit!=0)}
