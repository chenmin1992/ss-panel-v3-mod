											...
											<div class="tab-content">
												<div class="tab-pane fade active in" id="all_clash">
													...
													<div class="tab-pane fade active in" id="all_clash_info">
                                                        ...
                                                        <p> Clash 配置地址(国内外分流 + 流媒体代理)：<a class="copy-text" data-clipboard-text="{$baseUrl}/link/{$clash_sub_token}?cnip=1&sm=1"><code>{$baseUrl}/link/{$clash_sub_token}?cnip=1&sm=1</code></a></p>
													</div>
												...
												<div class="tab-pane fade" id="all_ssr">
													...
													<div class="tab-pane fade active in" id="all_ssr_info">
														...
														{$ssr_url_all = URL::getAllSSRUrl($pre_user, 0, 0)}
														{$ssr_url_all_mu = URL::getAllSSRUrl($pre_user, 1, 0)}
												...
												<div class="tab-pane fade" id="all_ss">
													...
													<div class="tab-pane fade active in" id="all_ss_info">
														...
														{$ss_url_all = URL::getAllSSRUrl($pre_user, 0, 1)}
														{$ss_url_all_mu = URL::getAllSSRUrl($pre_user, 1, 1)}
														{$ss_url_all_win = URL::getAllSSRUrl($pre_user, 0, 2)}
                                                ...
                                                <div class="tab-pane fade" id="all_v2ray">
                                                    <nav class="tab-nav margin-top-no">
                                                        <ul class="nav nav-list">
                                                            ...
                                                            <li>
                                                                <a class="waves-attach" data-toggle="tab" href="#all_v2ray_router"><i class="icon icon-lg">router</i>&nbsp;路由器</a>
                                                            </li>
                                                        </ul>
                                                    </nav>
                                                    ...
                                                    <div class="tab-pane fade" id="all_v2ray_windows">
                                                        <p><a href="/ssr-download/v2ray-win.zip">下载</a>，解压，运行程序，然后您有三种方式导入所有节点<br>
                                                            (1)下载<a href="/user/getpcconf?is_mu=0&is_ss=2">这个</a>，然后点击v2rayN图标 服务器 -- 添加自定义配置服务器，选择这个文件，<br>
                                                            (2)点击<a class="copy-text" data-clipboard-text="{$v2ray_url_all_v2}">这个</a>，然后点击v2rayN图标 服务器 -- 从剪贴板导入批量URL<br>
                                                            (3)(推荐)点击v2rayN图标 订阅 -- 订阅设置，添加，将订阅地址设置为下面的地址，改一个喜欢的备注，确定之后再更新订阅。<br>
                                                            <br>
